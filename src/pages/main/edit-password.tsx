...
export default function EditPassword() {
  ...
  const { getCredentialById, updateCredential } = useCredentials();
  ...
  useEffect(() => {
    if (id) {
      ...
      if (credential) {
        ...
        // Credential not found, redirect back
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update credential (encryption happens in the hook)
      updateCredential(id, { ...credentialData, type: "auth" });
  ...
  return (
    <Wrapper title="Edit Credentials">
      <motion.form
      ...
      >
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-line">
          <ButtonWithLoader
            type="submit"
            loading={loading}
            initialText="Update Credentials"
